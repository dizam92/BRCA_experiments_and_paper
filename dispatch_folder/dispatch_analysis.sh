...
python experiments/experiments_utilities.py run-analysis --directory /home/maoss2/project/maoss2/saving_repository_article/normal_experiments_brca --dict-for-prior-rules /home/maoss2/PycharmProjects/BRCA_experiments_and_paper/datasets/datasets_repository/groups2pathwaysTN_biogrid_msigDB.pck --output-text-file normal_brca_results_analysis --type-experiment normal --sous-experiment-types 'rf dt scm' --plot-hist
...
python experiments/experiments_utilities.py run-analysis --directory /home/maoss2/project/maoss2/saving_repository_article/groups_brca_experiments/eliminate_false/inner_group --dict-for-prior-rules /home/maoss2/PycharmProjects/BRCA_experiments_and_paper/datasets/datasets_repository/groups2pathwaysTN_biogrid_msigDB.pck --output-text-file group_scm_brca_results_analysis_eliminate_false_inner_group --type-experiment group_scm --sous-experiment-types 'methyl_rna_iso_mirna' --plot-hist
python experiments/experiments_utilities.py run-analysis --directory /home/maoss2/project/maoss2/saving_repository_article/groups_brca_experiments/eliminate_false/inner_group --dict-for-prior-rules /home/maoss2/PycharmProjects/BRCA_experiments_and_paper/datasets/datasets_repository/groups2pathwaysTN_biogrid_msigDB.pck --output-text-file group_scm_brca_results_analysis_eliminate_false_outer_group --type-experiment group_scm --sous-experiment-types 'methyl_rna_iso_mirna' --plot-hist

python experiments/experiments_utilities.py run-analysis --directory /home/maoss2/project/maoss2/saving_repository_article/groups_brca_experiments/eliminate_true/outer_group --dict-for-prior-rules /home/maoss2/PycharmProjects/BRCA_experiments_and_paper/datasets/datasets_repository/groups2pathwaysTN_biogrid_msigDB.pck --output-text-file group_scm_brca_results_analysis_eliminate_true_inner_group --type-experiment group_scm --sous-experiment-types 'methyl_rna_iso_mirna' --plot-hist
